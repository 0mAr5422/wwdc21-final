...
public class SortingAlgorithmsViewController: UIViewController {
    enum Section {
        case main
    }
...
extension SortingAlgorithmsViewController {
...
extension SortingAlgorithmsViewController : UICollectionViewDelegate {
